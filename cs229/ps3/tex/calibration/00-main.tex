...
\begin{enumerate}
  \input{calibration/01-logreg}

\ifnum\solutions=1 {
  \input{calibration/01-logreg-sol}
} \fi

  \input{calibration/02-accuracy}

\ifnum\solutions=1 {
  \input{calibration/02-accuracy-sol}
} \fi


  \input{calibration/03-l2-effect}

\ifnum\solutions=1 {
  \input{calibration/03-l2-effect-sol}
} \fi
